...
class CommandArgument(private val type: DiscordFlags.CommandArgumentType, val required: Boolean = true, val choices: DiscordChoiceMap<String> = DiscordChoiceMap(), val description: String = "Default Description") {
